 ...
 * File Contents
 *
 *    Register is responsible for collecting all the neccessary information from a user
 *    Register also makes sure that certain fields are not duplicates
 *    
 */
    ...
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                // This webpage was used to assist with modifying this file to include proper user registration
